...
\fd{En el libro Squeak by Example hablan de una expresion lambda , 
está bueno dejar un |x - x factorial pero sin una explicacion sobre dónde ir a buscar algo de expresiones
lambda me parece que queda descolgado. Para esta primera iteración yo paso de extenderme más }
...
\begin{itemize}
 \item Adele Goldberg, David Robson, \textit{Smalltalk-80, The Language}, Addison-Wesley, TODO: Capítulos
...
\end{minipage}
 \item Kent Beck, \textit{Smalltalk Best Practice Patterns}, Prentice-Hall, TODO: Capítulos
